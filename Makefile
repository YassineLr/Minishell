...
#    Updated: 2023/07/19 14:26:51 by ylarhris         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ./src/minishell.c ./src/parsing/file_opening.c ./src/parsing/lexer.c ./src/parsing/parser.c \
	...
	./src/builtins/cd.c ./src/builtins/pwd.c ./src/builtins/env.c ./src/builtins/echo.c ./src/builtins/export.c ./includes/linked_lists/ft_lstclear_env.c ./includes/linked_lists/ft_lstdelone_env.c \
